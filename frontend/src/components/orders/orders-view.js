...
export class OrdersView {
    ...
    showOrder(order) {
        ...
        if (order.scheduledDate) {
            const data = new Date(order.scheduledDate);
            document.getElementById('scheduled').innerText = data.toLocaleDateString('ru-RU');
        }
        ...
        if (order.deadlineDate) {
            const data = new Date(order.deadlineDate);
            document.getElementById('deadline').innerText = data.toLocaleDateString('ru-RU');
        }
